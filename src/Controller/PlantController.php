...
final class PlantController extends AbstractController{
    ...
    #[Route('/api', name: 'api_plants')]
    public function api_index(PlantRepository $repo): JsonResponse
    {
        return $this->json($repo->findAll(), 200, [], ['groups' => 'plant:read']);
    }

    #[Route('/api/{id}', name: 'api_plant_show', methods: ['GET'])]
    public function api_show(Plant $plant): JsonResponse
    {
